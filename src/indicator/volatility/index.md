...
The [chandelierExit](https://pkg.go.dev/github.com/TheServat/indicator#ChandelierExit) function sets a trailing stop-loss based on the Average True Value (ATR).
